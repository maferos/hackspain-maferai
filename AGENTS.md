...
- The camera viewport is Eloi's; the panels (Formulas asked over Current
  formula in the left drawer, Balance and Info in the dock under the camera,
  Formula chat down the right) are Martí's. The Real time /
