...
| `models/minihannover_scene.xml` | Demo scene: a perfumery lab (14 x 5 x 3 m) around the `minihannover` bench: amber-bottle library, one sink, five balances, GC-MS and UV-Vis-NIR, loose movable amber bottles |
...
| `assets/amber_bottles/`, `assets/reagent_jars/`, `assets/agro_bottles/` | Bottle / jar kits from `../assets/`, converted for MuJoCo |
